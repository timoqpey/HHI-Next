...
template class TBinEncoder<BinProbModel_MP>;
template class TBinEncoder<BinProbModel_MPI>;
template class TBinEncoder<BinProbModel_MPCW>;
...
template class TBitEstimator<BinProbModel_MP>;
template class TBitEstimator<BinProbModel_MPI>;
template class TBitEstimator<BinProbModel_MPCW>;
