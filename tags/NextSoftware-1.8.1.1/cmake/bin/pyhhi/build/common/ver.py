...
if __name__ == '__main__':
    #import sys
    v = parse_version_file('../../BoostBuild/include/BoostBuild/version.h')
    print("parse_version_file:", v)
    v = parse_version_file('../../BoostBuild/include/BoostBuild/version.h', True)
    print("parse_version_file:", v)
    v = parse_version_file('../../BoostBuild/src/test/QtHello/QtHello.app/Contents/Info.plist')
    print("parse_plist_file:", v)
    #sys.exit(0)
